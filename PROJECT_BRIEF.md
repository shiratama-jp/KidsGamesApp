# やさしいせかいシリーズ PWA化プロジェクト仕様書

## プロジェクト概要

幼児向けHTMLミニゲーム集「やさしいせかいシリーズ」をPWA（Progressive Web App）としてまとめ、スマートフォン・タブレットのホーム画面からアプリとして起動できるようにする。
...
- **カード集め報酬システム**: 1日5ゲームプレイでカードガチャ。localStorageで管理
- **プレイ記録**: 各ゲームのプレイ回数・最終プレイ日時をlocalStorageに保存
